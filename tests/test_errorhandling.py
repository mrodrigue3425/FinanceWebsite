...
class MockSuccessFetcher(BanxicoDataFetcher):
    ...
    def get_data(self):
        ...
        mock_summary = {'TIIE28': {'value': 7.8114, 'date': '29/10/2025'},
        ...
        curve_dates = ['27/10/2025', '27/10/2025', '27/10/2025', '27/10/2025', '27/10/2025']
...
class MockHTTPErrorFetcher:
    ...
    def get_data(self):
        ...
        http_error = requests.exceptions.HTTPError('503 Service Unavailable', response=mock_response)
